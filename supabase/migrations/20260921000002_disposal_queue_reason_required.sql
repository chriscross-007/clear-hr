-- CLE-225 — Broaden the meaning of disposal_queue.force_delete_reason
...
-- the pre-CLE-225 era remain valid). Enforcement of "reason required"
...
COMMENT ON COLUMN public.disposal_queue.force_delete_reason IS
  'Reason for the deletion. Free-text, 3..500 chars for user-initiated
   ...
   Nullable for legacy rows and for auto-deletes that predate CLE-225.';
